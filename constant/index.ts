export const StoreConfigaration = Object.freeze({
    storeInfo: {
        ...
        description:
            'Infinity is a small ecommerce site where you can explore and buy quality products at affordable prices.',
        startDate: new Date().toLocaleDateString(),
        avablityDatesInWakys: 'sun-sat',
        locale: 'en-US',
        keywords: ['ecommerce', 'online store', 'shopping', 'buy products', 'small business'],
    },
    payment: {
        bkash: {
